    ...
    <div class="login">
      ...
      <div class="login__form">
        ...
        <form action="" method="post" autocomplete="off">
          ...
          <input type="password" class="login__input name" name="pass1" placeholder="New Password" autocomplete="off" required/>
        </div>
        <div class="login__row">
          <svg class="login__icon pass svg-icon" viewBox="0 0 20 20">
            <path d="M0,20 20,20 20,8 0,8z M10,13 10,16z M4,8 a6,8 0 0,1 12,0" />
          </svg>
          <input type="password"class="login__input pass" name="pass2" placeholder="Confirm Password" autocomplete="off" required/>
        </div>
