...
The app (that is available on all platforms that use the App Store and Google Play) contains various helpful features to make your experience with Fibonia be at ease at all times and costs! Some features that are included are login/registration systems, real-time updates, etc!
	...
	<div class="column">
		<div href="phonenew.php" class="phone iphone1"><div class="screen"></div></div>
    ...
    <div class="column">
    	&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp<a href="phonenew.php"><div class="cta"><i class="fa fa-apple" aria-hidden="true"></i><i class="fa fa-android" aria-hidden="true"></i> Check it out!</div></a>
    </div></div>
	</div>
	...
	<div class="row">
	<div class="footer">
    <a href="aboutusnew.php">About Us</a> | <a href="aboutusnew.php">Blog</a> | <a href="home.php">Tutorials</a><br>
    <a href="https://facebook.com/yakubyan">Facebook</a> | <a href="https://www.instagram.com/abyac_999/">Instagram</a> | <a href="termsnew.php">Terms of Service</a> | <a href="privacynew.php">Privacy Policy</a> </div>
	</div>
