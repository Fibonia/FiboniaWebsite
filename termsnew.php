...
<head><meta charset="windows-1252">
    <meta name="description" content="Terms and Conditions of our established company, Fibonia.">
</head>
<title>Terms | Fibonia</title>
<html>
    <script type="text/javascript" src= "redirect.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
<style>
@media only screen and (max-height: 800px) {p{font-size:1.5rem !important;} .wrapper{top:14% !important;}}
</style>
...
<section class="content">
    ...
    <h2>Terms & Conditions</h2>
        ...
        <p>Our Website is a hub for tutors. fibonia does not provide or control any of the tutors and information that you can access through the Website, such as appointments, display information, payments, etc. Much of the features of the appointments are owned, controlled or made available by third parties using an API, which includes Stripe, Berkeleytime, Venmo, Google, and Facebook. These Feature Providers are responsible for the ease of requesting tutors and completing the appointments. The terms and privacy policies of the Feature Provider apply to your appointment so your interaction with any provided Tutor accessed through our Website is at your own risk; Fibonia does not bear any responsibility should anything go wrong with your appointment or during your tutoring session.
</p>
        <p>If you make an appointment through Our Website, that booking is made with the Tutor named on the appointment pairing page and Our Website only acts as a user interface. Accordingly, fibonia has no responsibility for the appointment or the Tutor because Fibonia has no involvement in creating the description of the Tutor's information, in defining the price and any fees, or in providing the Tutors that you book. If you have any issues or disputes with your Tutor, you agree to address and resolve these with the Tutor and not with us.</p>
      </section>
      </div></div>
<style>
  ...
  <i class="fa fa-bars fa-3x"></i>
    <div class="header-links">
      ...
      <ul>
        ...
        <li data-menuanchor="fourthPage"><a href="home.php#contact">CONTACT</a></li>
        <li data-menuanchor="secondPage"><a href="home.php#about">ABOUT</a></li>
