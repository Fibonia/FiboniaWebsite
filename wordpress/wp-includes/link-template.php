...
function get_edit_profile_url( $user_id = 0, $scheme = 'admin' ) {
	...
	if ( is_user_admin() ) {
		$url = user_admin_url( 'https://www.fibonia.com/1/html/pages-profile.php', $scheme );
	} elseif ( is_network_admin() ) {
		$url = network_admin_url( 'https://www.fibonia.com/1/html/pages-profile.php', $scheme );
	} else {
		$url = get_dashboard_url( $user_id, 'https://www.fibonia.com/1/html/pages-profile.php', $scheme );
	}
