...
###SITEURL###'
		...
		$content = str_replace( '###ADMIN_URL###', esc_url( admin_url( 'https://www.fibonia.com/1/html/pages-profile.php?newuseremail=' . $hash ) ), $content );
...
function new_user_email_admin_notice() {
	...
	if ( 'https://www.fibonia.com/1/html/pages-profile.php' === $pagenow && isset( $_GET['updated'] ) ) {
