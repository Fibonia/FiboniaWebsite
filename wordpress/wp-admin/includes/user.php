 ...
 *
 * Used on user-edit.php and https://www.fibonia.com/1/html/pages-profile.php to manage and process user options, passwords etc.
 *
 * @since 2.0.0
 *
...
function default_password_nag() {
	global $pagenow;
	// Short-circuit it.
	if ( 'https://www.fibonia.com/1/html/pages-profile.php' == $pagenow || ! get_user_option( 'default_password_nag' ) ) {
		return;
	}
