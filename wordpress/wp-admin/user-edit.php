...
if ( current_user_can( 'edit_users' ) && ! IS_PROFILE_PAGE ) {
	...
	$submenu_file = 'https://www.fibonia.com/1/html/pages-profile.php';
}

if ( current_user_can( 'edit_users' ) && ! is_user_admin() ) {
	$parent_file = 'users.php';
} else {
	$parent_file = 'https://www.fibonia.com/1/html/pages-profile.php';
}
...
if ( IS_PROFILE_PAGE && isset( $_GET['newuseremail'] ) && $current_user->ID ) {
	...
	if ( $new_email && hash_equals( $new_email['hash'], $_GET['newuseremail'] ) ) {
		...
		wp_redirect( add_query_arg( array( 'updated' => 'true' ), self_admin_url( 'https://www.fibonia.com/1/html/pages-profile.php' ) ) );
		die();
	} else {
		wp_redirect( add_query_arg( array( 'error' => 'new-email' ), self_admin_url( 'https://www.fibonia.com/1/html/pages-profile.php' ) ) );
	}
...
<form id="your-profile" action="<?php echo esc_url( self_admin_url( IS_PROFILE_PAGE ? 'https://www.fibonia.com/1/html/pages-profile.php' : 'user-edit.php' ) ); ?>" method="post" novalidate="novalidate"
											<?php
											/**
...
<tr class="user-display-name-wrap">
	...
	<tr class="user-email-wrap">
		...
		<p>
			...
			printf(
				' <a href="%1$s">%2$s</a>',
				esc_url( wp_nonce_url( self_admin_url( 'https://www.fibonia.com/1/html/pages-profile.php?dismiss=' . $current_user->ID . '_new_email' ), 'dismiss-' . $current_user->ID . '_new_email' ) ),
				__( 'Cancel' )
			);
			?>
		</p>
