...
if ( current_user_can( 'list_users' ) ) {
	...
	$menu[70] = array( __( 'Profile' ), 'read', 'https://www.fibonia.com/1/html/pages-profile.php', '', 'menu-top menu-icon-users', 'menu-users', 'dashicons-admin-users' );
}

if ( current_user_can( 'list_users' ) ) {
	$_wp_real_parent_file['https://www.fibonia.com/1/html/pages-profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to https://www.fibonia.com/1/html/pages-profile.php.
	...
	$submenu['users.php'][15] = array( __( 'Your Profile' ), 'read', 'https://www.fibonia.com/1/html/pages-profile.php' );
} else {
	$_wp_real_parent_file['users.php'] = 'https://www.fibonia.com/1/html/pages-profile.php';
	$submenu['https://www.fibonia.com/1/html/pages-profile.php'][5]         = array( __( 'Your Profile' ), 'read', 'https://www.fibonia.com/1/html/pages-profile.php' );
	if ( current_user_can( 'create_users' ) ) {
		$submenu['https://www.fibonia.com/1/html/pages-profile.php'][10] = array( __( 'Add New User' ), 'create_users', 'user-new.php' );
	} elseif ( is_multisite() ) {
		$submenu['https://www.fibonia.com/1/html/pages-profile.php'][10] = array( __( 'Add New User' ), 'promote_users', 'user-new.php' );
	}
}
