...
<div class="chat-pop-up chat-display-on chat-visible">
  ...
  <a onclick=\ "window.open('" + urlToGo + "', (Math.floor(Math.random()*100000)), 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=0,width=700,height=710,left = 310,top = 275');\" href="contactusnew.php" id=init-flash-frame class=button-yellow>
    <span>
      Contact Us
    </span>
...
</style></head><link rel="icon" type="image/png" href="logo.png"><body><script type='text/javascript' data-cfasync='false'>window.purechatApi = { l: [], t: [], on: function () { this.l.push(arguments); } }; (function () { var done = false; var script = document.createElement('script'); script.async = true; script.type = 'text/javascript'; script.src = 'https://app.purechat.com/VisitorWidget/WidgetScript'; document.getElementsByTagName('HEAD').item(0).appendChild(script); script.onreadystatechange = script.onload = function (e) { if (!done && (!this.readyState || this.readyState == 'loaded' || this.readyState == 'complete')) { var w = new PCWidget({c: '572a0b6b-4be8-43b0-b0ad-f1c8e6254bf5', f: true }); done = true; } }; })();</script>
<div id="app"></div>
<nav role="navigation">
  <div id="menuToggle">
    <input type="checkbox" />
...
<a href="logout.php" target="_self" class="icon-link sign-link" style = "color: white">Sign Out</a>
<a href="https://www.fibonia.com/1/html/pages-profile.php" target="_self" class="icon-link profile-link" style = "color: white">Profile</a>
  ...
  CitiesSlider.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        'Top offers include these places!'
      ),
      React.createElement(
        'div',
        ...
        this.props.slides.map(function (slide, index) {
          return React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                { className: 'slider__slide-readmore',onClick: function onClick(){window.location = 'offersnew.php'}},
                'read more'
              )
            ),
            React.createElement(
