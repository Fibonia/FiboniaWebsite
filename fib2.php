...
<a onclick="login(); move();" target="_self" ><div class="button1">Sign In/Register</div></a>
<a href="" style="opacity:0;z-index:-1;"><div class="button2">Continue As Guest</div></a>
<style>
.button1 {
    flex: 1 1 auto;
    border-radius:100px;
      ...
      <form>
        <div class="inner-form">
          <div class="input-field first-wrap">
            ...
            <input id="search_input" type="text" placeholder="Enter Location" />
          </div>
...
<input placeholder="Class" list="brow">
<datalist id="brow">
...
<option value='YIDDISH 110'>
          ...
          <div class="input-field fifth-wrap">
            <button  onclick="changeZIndex3();" id = "x1" class="btn-search" type="button">&#43; ADD CLASS</button>
          </div>
...
<iframe id = "a" class="hid" src="test.html" scrolling="no" allowTransparency="true" style="position:absolute;right:145px;width:25%;top:105px;background-color: rgba(0,0,0,0);" frameBorder="0"></iframe>
<iframe class="loginhelp hid" src="loginhome.php" scrolling="no" allowTransparency="true" frameBorder="0"></iframe>
        </div>
      </form>
    </div>
...
<nav role="navigation">
  <div class = "fade-in" id="menuToggle">
    <div target="_self" class="icon-link1 sign-link">Sign in/Register</div><div target="_self" class="icon-link2 sign-link2" style="opacity:0;z-index:-1;" >Or</div><div href="" target="_self" class="icon-link1 sign-link1" style="opacity:0;z-index:-1;" >Continue As a Guest</div>
...
<div class='split-pane col-xs-12 col-sm-6 frontend-side'>
  <div>
    ...
    <a href="https://www.work.fibonia.com" class='button'>
