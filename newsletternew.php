...
?>
<head>
    <meta name="description" content="Be the first to receive the latest Fibonia news, exclusive deals, and product updates!">
</head>
<title>Newsletters | Fibonia</title>
      ...
      <div class="overlay" style="">
        ...
        <div class="container">
          <div class="row center-vh">
            ...
            <div class="col-md-6">
              <h1 class="text-center-xs text-uppercase" style = "color: white;">Fib<span>Onia</span></h1>
              <p class="text-center-xs lead text-uppercase">Fibonia Newsletters</p>
              <p class="text-center-xs">Be the first to receive the latest Fibonia news, exclusive deals, and product updates!

</p>
              <button onclick="location.href='contactus.php'" class="text-center-xs1">Contact Us</button>
            </div>

            <div class="col-md-6">
              <form class="center-block" action="newsletter-signup1.php" method="post">
                <h2 style="color:white" class="text-center">Sign up for<span> Fibonia </span>newsletters today!</h2>
                ...
                <input style="background-color:royalblue;font-size:20px;color:white;" class="btn btn-block text-center-xs1" type="submit" value="Get Started" style="color:white;"/>
              </form>
            </div>
