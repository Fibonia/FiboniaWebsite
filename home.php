...
<label  class="container6">Would you like to get tutoring for free?
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
        ...
        <link rel="icon" type="image/png" href="logo.png">
        <meta name="description" content="Welcome to Fibonia, a peer-to-peer tutoring platform that lets UC Berkeley students become freelance tutors for classes they've done well in.">
    </head>
    	<script>
...
db.collection("users").where("email", "==", "<?php echo $id; ?>")
  .get()
  .then(function(querySnapshot) {
      querySnapshot.forEach(function(doc) {
          ...
          db.collection("users").doc("<?php echo $id; ?>").update({update_classes: ourdata}).then(function(tst){
