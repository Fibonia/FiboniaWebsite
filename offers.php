...
<nav role="navigation">
  <div id="menuToggle">
      <a href="login.php" target="_self" class="icon-link1 sign-link" style = "color: white">Sign in/Register</a><a target="_self" class="icon-link2 sign-link2" style = "color: white;opacity:0;z-index:-1;">Or</a><a href="" target="_self" class="icon-link1 sign-link1" style = "color: white;opacity:0;z-index:-1;">Continue As a Guest</a>
    <input type="checkbox" />
    <span></span>
    <span></span>
    <span></span>
    ...
    <div class="slide slide-0 active">
      ...
      <div class="slide__content">
        ...
        <div class="slide__text">
          ...
          <a href="fib.php"class="slide__text-link" style="font-family: 'Open Sans Condensed', sans-serif; color: rgb(255,255,255)">Learn More</a>
        </div>
      </div>
    </div>
