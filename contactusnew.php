  ...
  <div class="sections">
    <div class="section section-1">
      ...
      <div class="content">
        ...
        <div class="bg-part"></div>
        <div class="bg-part"></div>
	<a href="logout.php" target="_self" class="icon-link sign-link1" style = "color: white">Sign Out</a>
...
<div class="container">
            <div id="form-main">
                <div id="form-div">
                    <form class="montform" id="reused_form" method="post" action="contactus2.php" style="width: 812px" >
                        <p class="name">
                            &nbsp;</p>
						<p1>
