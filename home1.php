...
<div class="popup popup--icon -success js_success-popup popup--visible" id = "popup_this11" >
  ...
  <div class="popup__content">
    <form method="post">
<label style="margin-right: 45%;">Price/Hour (in $):</label> <iframe id = "bar" class="hid" src="test.html" scrolling="no" allowTransparency="true" style="position:absolute;right: 8%;width: 40%;height:25%;top:130px;background-color: rgba(0,0,0,0);" frameBorder="0"></iframe><br></br>
<label>Or</label><br></br>
<label  class="container6">Would you like to tutor for free?
  <input name="freetutor" id="freetutor" type="checkbox" >
...
<div class="nav-header">
  ...
  <div class="nav-brand">
    ...
    <a href="home.php"><img style="border-radius:100%" src="https://i.imgur.com/SdOFtdE.png"></a>
...
.wrapper,.s12 {
 ...
 <div class="relative">
  <div class="absolute">
    <h1 class="fixed-feedback">SEARCH CLASS, PICK TUTOR, AND LEARN!</h1>
  </div>
</div> 
    <input class="search" list="brow" type="text" id="search" />
    <datalist id="brow">
...
<option value='YIDDISH 110'>
		...
		<input class="submit" style="font-size:18px;font-weight:bold;" id="butsave" type="submit" value="Search" /></div></div>
...
$('#butsave3').on('click', function() {
		...
		minprice = value1;
		var classes = document.getElementById('search').value;
...
.waveAnimation .waveBottom {
  ...
  <i class="fa fa-bars fa-3x"></i>
    <div class="header-links">
      ...
      <ul>
        <li data-menuanchor="eigthPage"><a href="termsnew.php">TERMS</a></li>
        <li data-menuanchor="seventhPage"><a href="privacynew.php">PRIVACY</a></li>
        <li data-menuanchor="sixthPage"><a href="faqnew.php">FAQ</a></li>
        <li data-menuanchor="fifthPage"><a href="newsletternew.php">NEWSLETTER</a></li>
        ...
        <li data-menuanchor="secondcPage"><a href="1/html/pages-profile.php">PROFILE</a></li>
        <li data-menuanchor="firstPage"><a href="logout.php">SIGN OUT</a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <div class="nav-container">
    <div class="nav-links">
      <ul id='myMenu'>
        ...
        <li data-menuanchor="sixthPage"><a href="faqnew.php">FAQ</a></li>
        <li data-menuanchor="seventhPage"><a href="privacynew.php">PRIVACY</a></li>
        <li data-menuanchor="eightPage"><a href="termsnew.php">TERMS</a></li>
      </ul>
    </div>
  </div>
...
<div id="fullpage">
  ...
  <div class="section aboutme" data-anchor="aboutme">
    <div style="z-index:100;" class="opaque-bg animated fadeInDown">
      <h1 style="color:white;"><span style="color:royalblue">/</span></h1>
  ...
  <div class="section" data-anchor="skills">
    <div class="content">
      ...
      <p class="wow fadeInDown" data-wow-delay="0.2s">The startup "Fibonia" was developed by co-founders Abel Yagubyan and Gurkaran Goindi, a group of Computer Science students from the bay area receiving education at the University of California at Berkeley, at the beginning of June 2019. After a year of hard work, this company has been fully established as of August 2020. Fibonia contains a strong team of members that assure you the best tutoring service for you with the best security possible. The website and app were developed by Abel Yagubyan and Gurkarn Goindi.</p>
<div style="display:flex;">
<div style="margin-right:25%;margin-left:10%;" class="raspberry">
<img style="width:130%;border-radius:100%;" src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG">
<p style="cursor:default;margin-left:10%;width:100%;">&nbsp;&nbsp;Abel Yagubyan</p>
  </div><p style="display:inline;cursor:default;"></p>
<div class="raspberry1">
<img style="width:55%;border-radius:100%;" src="https://scontent-lax3-1.xx.fbcdn.net/v/t1.0-9/44144911_1126781074143218_5433298242651553792_n.jpg?_nc_cat=100&_nc_sid=174925&_nc_ohc=TIm9j3LWzAUAX_clJjm&_nc_ht=scontent-lax3-1.xx&oh=17850cebe8ad73de378d857546ff3070&oe=5F647AE5">
<p >Gurkaran Goindi</p>
</div>
      </div>
    </div>
