      ...
      <div class="page page-1">
        <div class="page__headings">
          ...
          <h4 class="page__headings-sub">
            ...
            <a href="https://codepen.io/suez/pen/emjwvP" target="_blank" class="page__headings-link">iOS/Android</a>
          </h4>
        </div>
      </div>
...
<nav role="navigation">
    			 ...
    			 <span></span>
    			  <ul id="menu" style="left: 6px; top: 56px">
      				<a href="fib.php"><li text-decoration: None>Home</li></a>
