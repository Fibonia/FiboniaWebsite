...
@media only screen and (max-height: 800px) {.searchbody{width:50% !important; height:500px !important;} #container{margin-right:-50% !important;}}
@media only screen and (max-height: 600px) {.searchbody{width:40% !important; height:400px !important;} #container{margin-right:-20% !important;margin:2% auto !important;} }
@media only screen and (max-width: 1024px) {.searchbody{width:70% !important; height:500px !important;} #container{margin-right:-20% !important;}}
...
<div style="max-width:100%;max-height:100%;" id="container">
  ...
  <div style="z-index:1000;" id="cover">
      ...
      <p style="color:white" class="sign-up">Enter your email address and <br>we'll send you a link to reset your password.</p>
      <a class="button1 sign-up" href="fib.php" onclick="myFunction5()">&#8592; Go Back</a>
  ...
  <div style="z-index:999;" id="login">
    ...
    <p>Enter your email account:</p>
      <input type="text" id="email" name="email" placeholder="E-mail" autocomplete="off" required><br>
      <input type="text" id="email1" name="email1" placeholder="Confirm E-mail" autocomplete="off" required><br>
      <div style="color:red" id="errortxtdiv"><p id="errortxt"></p></div>
      <div style="color:green" id="errortxtdiv1"><p id="errortxt1"></p></div>
      <input class="submit-btn" type="button" id="resetbutton" value="Send reset link">
  </div>
		...
		if(5 == 5){
		    ...
		    email1 = $('#email1').val();
					...
					if(email == email1){
					    ...
					    document.getElementById("errortxtdiv").innerHTML = "";
var actionCodeSettings = {
  url: 'https://www.fibonia.com/fib.php',
  handleCodeInApp: false
};
					    var auth = firebase.auth();
					    auth.sendPasswordResetEmail(email).then(function() {
					        document.getElementById("errortxtdiv1").innerHTML = "Instructions have been sent to your email!";
                              document.getElementById("errortxtdiv").innerHTML = "";
                        }).catch(function(error) {
					        document.getElementById("errortxtdiv1").innerHTML = "";
                              document.getElementById("errortxtdiv").innerHTML = "There was an error contacting your email!";
                        });
					} else{
					    document.getElementById("errortxtdiv1").innerHTML = "";
					    document.getElementById("errortxtdiv").innerHTML = "Emails do not match!";
					}
		}
	});
</script>
