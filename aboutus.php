...
if (isset($_SESSION['loggedin']) || isset($_SESSION['userData1']) || isset($_SESSION['userData'])) {
	header('Location: aboutusnew.php');
	exit();
}
?>
<head>
    <link rel="icon" type="image/png" href="logo.png">
<meta name="description" content="From the hallways of Cory Hall at UC Berkeley to San Francisco, take a look at the company's initial beginnings to its current state.">
...
<a href="login.php" target="_self" class="icon-link sign-link" style = "color: white">Sign in/Register</a><a target="_self" class="icon-link sign-link2" style = "color: white;opacity:0;z-index:-1;">Or</a><a href="" target="_self" class="icon-link sign-link1" style = "color: white;opacity:0;z-index:-1;">Continue As a Guest</a>
    <div class="content ">
      <div class="header-top overflow ">
        <a href="fib.php" class="header-company-name " style = "color: white">Fibonia</a>
      ...
      <div class="title-group ">
        <p class="title-group-top ">About Us</p>
        <h1 class="title-group-main ">Welcome to Fibonia</h1>
      </div>
      <a href="#down" class="header-button ">
        Learn more
      </a>
  <div id="down">
  </div>
  ...
  <section class="about-us ">
    <div class="content ">
      <div class="title-group ">
        <p class="title-group-top ">What we do</p>
        <h2 class="title-group-main ">Story about us</h2>
      </div>
      <p class="story ">The company was founded by a group of Computer Science students from the bay area receiving education at the University of California at Berkeley. After a year of hard-work, this company has been fully established as of June, 2020.</p>

      <article class="images-group clearfix ">
...
<p class = "story ">The company "Fibonia" was developed by co-founders Abel Yagubyan and Gurkaran Goindi at the beginning of June,2019. The team now contains a strong team of 3 members that assure the best of service for you with the best security possible. The algorithm and the back-end work of the website was developed by co-founders Abel Yagubyan and Gurkarn Goindi. Marketing and rest of the work is developed by Druv Punjabi.</p>
  </section>
<div id= "down2">
</div>
  <section class="facts ">
    <div class="content ">
      <article class="facts-group clearfix ">
        <div class="facts-group-child1 ">
          <p>120</p>
          <p>Satisfied Customer Reviews</p>
        </div>
        <div class="facts-group-child2 ">
          <p>1.2k</p>
          <p>Trip Sales</p>
        </div>
        <div class="facts-group-child3 ">
          <p>15</p>
          <p>Awards Won</p>
        </div>
        <div class="facts-group-child4 ">
          <p>1</p>
          <p>Year in the making</p>
        </div>
        <div class="facts-group-child5 ">
          <p>5</p>
          <p>Sponsors</p>
        </div>
      </article>
  ...
  <section class="service ">
    <div class="content ">
      <div class="title-group ">
        <p class="title-group-top ">We work with</p>
        <h2 class="title-group-main ">Amazing services</h2>
      </div>

      <div class="features clearfix ">
        <div class="block border_bottom ">
          <img alt="logo" src="https://i.lensdump.com/i/8KROpF.png">
          <h3 class="service-header ">Service Time</h3>
          <p class="">We always assure for quick service and response under any inconvenience presented to our customers.</p>
        </div>
        <div class="block border_bottom ">
          <img alt="logo" src="https://i.lensdump.com/i/8KReoq.png">
          <h3 class="service-header ">Trip Sales</h3>
        ...
        <div class="block border_bottom ">
          ...
          <h3 class="service-header ">Web Security</h3>
        ...
        <div class="block ">
          ...
          <h3 class="service-header ">Trip Offers</h3>
        ...
        <div class="block ">
          ...
          <h3 class="service-header ">Home Page</h3>
        ...
        <div class="block ">
          ...
          <h3 class="service-header ">Digital Apps</h3>
    ...
    <div class="content overflow">
      ...
      <div>
        ...
        <div class="footer-instagram">
          <a href=""><img src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG"></a>
          <a href=""><img src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG"></a>
          <a href=""><img src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG"></a>
          <a href=""><img src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG"></a>
          <a href=""><img src="https://berkeley.learningu.org/media/uploaded/bio_pictures/19_02/photo.PNG"></a>
